...
export const projects: Project[] = [
  ...
  },
  {
    ...
    github: "https://github.com/Rabeebaqdas/Automated-Raffle",
  ...
  },
  {
    ...
    github: "https://github.com/Rabeebaqdas/Krypt",
    technologies: getSkill(["html", "css", "javascript", "NodeJS", "solidity", "hardhat", "react","EthersJS"])
  },
  {
    name: "Flash Loan Arbitrage",
    description: "A smart contract-based program in which the user is taking a loan from the Aave platform and earning a profit by arbitrage trading.",
    url: "https://github.com/Rabeebaqdas/FlashLoanArbitrage",
    github: "https://github.com/Rabeebaqdas/FlashLoanArbitrage",
    technologies: getSkill(["solidity", "hardhat", "NodeJs", "javascript","EthersJS"])
  },
  {
    name: "Liquidity Pool",
    description: "A smart contract-based program in which a pool is created by using  uni swap V2, user can swap their tokens from that pool.",
    url: "https://github.com/Rabeebaqdas/Liquidity-Pool",
    github: "https://github.com/Rabeebaqdas/Liquidity-Pool",
    technologies: getSkill(["solidity", "hardhat", "NodeJs", "javascript","EthersJS"])
  },
  {
    name: "Random NFT Generator",
    description: "Shows on-chain stats off user's address. User can add personal contacts for easy assets transfer.",
    url: "https://github.com/Rabeebaqdas/Random_NFT_Generator",
    github: "https://github.com/Rabeebaqdas/Random_NFT_Generator",
    technologies: getSkill(["solidity", "hardhat", "NodeJs", "javascript","EthersJS","Pinata","IPFS"])
  },
